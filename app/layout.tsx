  ...
  return (
    <html lang="vi">
      <body className="flex min-h-screen flex-col bg-gray-50 text-gray-900">
        <header className="sticky top-0 z-40 bg-white text-gray-900 shadow-md border-b border-gray-200">
          ...
          <nav className="flex gap-4 overflow-x-auto border-t border-gray-200 px-4 py-2 text-sm font-medium md:hidden">
            {navLinks.map((link) => (
              <Link key={link.label} href={link.href} className="whitespace-nowrap hover:underline">
                {link.label}
              </Link>
            ))}
          </nav>
        ...
        <footer className="mt-12 border-t border-gray-200 bg-white text-gray-900">
