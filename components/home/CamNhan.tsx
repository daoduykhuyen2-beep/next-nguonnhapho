...
export default function CamNhan() {
  return (
    ...
    <div className="mb-5">
    <h2 id="cam-nhan-heading" className="text-xl font-bold text-brand sm:text-2xl">Khach hang & moi gioi noi gi ve Nguon Nha Pho</h2>
    <p className="mt-1 text-sm text-gray-500">Nhung chia se that long tu nguoi da mua ban, cho thue va tu nguoi truc tiep lam nghe cung chung toi.</p>
    </div>
    <div className="mb-3 text-sm font-semibold uppercase tracking-wide text-gray-400">Khach hang chia se</div>
    ...
    <div className="mb-3 mt-8 text-sm font-semibold uppercase tracking-wide text-gray-400">Sale lam viec tai Nguon Nha Pho</div>
