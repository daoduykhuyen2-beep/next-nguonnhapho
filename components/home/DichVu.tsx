...
export default function DichVu() {
  return (
    ...
    <div className="mb-5">
    <h2 id="dich-vu-heading" className="text-xl font-bold text-brand sm:text-2xl">Nguon Nha Pho giup ban viec gi?</h2>
    <p className="mt-1 text-sm text-gray-500">Chon dung viec ban dang can, chung toi dan ban den kho tin va cong cu phu hop nhat.</p>
    </div>
    <ul className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <Link href={dv.href} className="mt-3 inline-block text-sm font-semibold text-brand hover:underline">Xem chi tiet &rarr;</Link>
      </li>
      ))}
    </ul></section>
    );
