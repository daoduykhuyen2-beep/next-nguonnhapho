        ...
        {open === "app" && (
          <div className="absolute right-0 z-50 mt-2 w-72 rounded-xl border border-gray-200 bg-white p-4 shadow-xl">
            <div className="flex items-center gap-2">
              ...
              <span className="rounded-full bg-red-100 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-red-600">Sắp ra mắt</span>
            </div>
            <p className="mt-1 text-xs font-normal text-gray-500">
              Ứng dụng di động đang được hoàn thiện. Chúng tôi sẽ sớm ra mắt trên App Store và Google Play — hãy quay lại sau nhé!
            </p>
            <div className="mt-3 flex items-center gap-3">
              <div className="flex h-24 w-24 flex-col items-center justify-center gap-1 rounded-lg border border-dashed border-gray-300 bg-gray-50 text-[10px] font-semibold text-gray-400">
                <span>QR CODE</span>
                <span>Sắp ra mắt</span>
              </div>
              <div className="flex flex-col gap-2">
                <span className="cursor-not-allowed rounded-md bg-gray-300 px-3 py-2 text-center text-xs font-semibold text-white">App Store · Sắp có</span>
                <span className="cursor-not-allowed rounded-md bg-gray-300 px-3 py-2 text-center text-xs font-semibold text-white">Google Play · Sắp có</span>
              </div>
            </div>
          </div>
        )}
