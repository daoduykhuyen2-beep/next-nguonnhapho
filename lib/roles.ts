// Client-safe: types, capability map, labels va cac ham thuan logic (khong dung supabase).
// Tach ra tu lib/permissions.ts de RoleSelect (client) import ma khong keo theo next/headers.
